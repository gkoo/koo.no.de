var Resume = function() {
  this.experiences = [
    ...
    { company: 'ChoiceVendor',
      ...
      description: '<p>My work on the ChoiceVendor website involved responsibilities ranging from the business logic to the presentation level of the application. I worked on developing the application logic, which was written in Python using the Django framework. On the front end, I created the Jinja2 templates and the CSS and Javascript that accompanied them.</p><p>ChoiceVendor was <a href="http://techcrunch.com/2010/09/23/linkedin-choicevendor/" target="_blank">acquired by LinkedIn</a> in September 2010.</p>' },
    { company: 'Oracle',
