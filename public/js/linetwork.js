  ...
  ConnectionsView = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      if (this.collection) {
        ...
        this.collection.bind('add', function(cxn) {
          var pos,
              newPic = new ConnectionPic({ model: cxn });
          _this._connectionPicViews.push(newPic);
          pos = _this._connectionPicViews.length-1;
          $(_this.el).append(newPic.render().el);
          return _this;
        });
